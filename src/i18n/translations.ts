export const translations = {
  en: {
    ...
    "hero.wander.body": "Your earned time — softly tracked by a glowing amber arc, never counting down.",
    "hero.home.title": "Come Home",
    "hero.home.body": "A letter at the edge of your attention — not an alarm, not a lock. Just warmth.",
    ...
    "problem.body": "Five hours a day. 144 unlocks. The reach is automatic — your thumb moves before you've decided. You don't need another lock. You need someone to gently say:",
    ...
    "how.pause.body": "You reach for Instagram. A warm screen appears — amber light, soft breathing cues. Sixty seconds of guided presence before you scroll.",
    "how.wander.title": "The Wander",
    "how.wander.body": "You earned your access. Ten minutes — they're yours. A gentle amber arc tracks the time, never counting down, just glowing softly.",
    "how.home.title": "Come Home",
    "how.home.quote": "\"Almost time to come home.\"",
    "how.home.body": "Not an alarm. Not a lock. A letter, arriving softly at the edge of your attention.",

    // Features — Rituals
    "rituals.title": "Two rituals. One golden hour.",
    "rituals.first.title": "First Light",
    "rituals.first.sub": "The morning pause",
    "rituals.first.body": "Before the world rushes in — a moment to arrive in your own day. Warmer gradients, a slightly faster breath. The sun is rising. So are you.",
  ...
  es: {
    ...
    "hero.wander.body": "Tu tiempo ganado — medido suavemente por un arco ámbar, sin cuenta regresiva.",
    "hero.home.title": "Volver a Casa",
    "hero.home.body": "Una carta al borde de tu atención — no una alarma, no un bloqueo. Solo calidez.",
    ...
    "problem.body": "Cinco horas al día. 144 desbloqueos. El gesto es automático — tu pulgar se mueve antes de que lo decidas. No necesitas otro bloqueo. Necesitas que alguien te diga con suavidad:",
    ...
    "how.pause.body": "Buscas Instagram. Aparece una pantalla cálida — luz ámbar, respiración guiada. Sesenta segundos de presencia antes de hacer scroll.",
    "how.wander.title": "El Paseo",
    "how.wander.body": "Te ganaste tu acceso. Diez minutos — son tuyos. Un arco ámbar marca el tiempo suavemente, sin contar hacia atrás.",
    "how.home.title": "Volver a Casa",
    "how.home.quote": "\"Casi es hora de volver a casa.\"",
    "how.home.body": "No es una alarma. No es un bloqueo. Una carta, que llega suavemente al borde de tu atención.",

    "rituals.title": "Dos rituales. Una hora dorada.",
    "rituals.first.title": "Primera Luz",
    "rituals.first.sub": "La pausa matutina",
    "rituals.first.body": "Antes de que el mundo entre corriendo — un momento para llegar a tu propio día. Gradientes más cálidos, una respiración más rápida. El sol está saliendo. Tú también.",
  ...
  it: {
    ...
    "hero.wander.body": "Il tuo tempo guadagnato — tracciato dolcemente da un arco ambrato, senza conto alla rovescia.",
    "hero.home.title": "Tornare a Casa",
    "hero.home.body": "Una lettera ai margini della tua attenzione — non un allarme, non un blocco. Solo calore.",
    ...
    "problem.body": "Cinque ore al giorno. 144 sblocchi. Il gesto è automatico — il pollice si muove prima che tu abbia deciso. Non hai bisogno di un altro blocco. Hai bisogno di qualcuno che dica gentilmente:",
    "problem.quote": "\"Dear Wander, restiamo qui un momento.\"",

    "how.title": "Come funziona",
    "how.subtitle": "Tre momenti. Un'interruzione gentile.",
    "how.pause.title": "La Pausa",
    "how.pause.body": "Cerchi Instagram. Appare uno schermo caldo — luce ambrata, respiro guidato. Sessanta secondi di presenza prima di scorrere.",
    "how.wander.title": "La Passeggiata",
    "how.wander.body": "Hai guadagnato il tuo accesso. Dieci minuti — sono tuoi. Un arco ambrato segna il tempo dolcemente, senza contare alla rovescia.",
    "how.home.title": "Tornare a Casa",
    "how.home.quote": "\"È quasi ora di tornare a casa.\"",
    "how.home.body": "Non un allarme. Non un blocco. Una lettera, che arriva dolcemente ai margini della tua attenzione.",

    "rituals.title": "Due rituali. Un'ora dorata.",
    "rituals.first.title": "Prima Luce",
    "rituals.first.sub": "La pausa mattutina",
    "rituals.first.body": "Prima che il mondo irrompa — un momento per arrivare nella tua giornata. Gradienti più caldi, un respiro leggermente più veloce. Il sole sta sorgendo. Anche tu.",
