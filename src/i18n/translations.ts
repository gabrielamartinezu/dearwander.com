export const translations = {
  en: {
    ...
    "how.subtitle": "The daily self-regulation loop. From reflex to choice in three moments.",
    "how.intention.title": "The Morning Intention",
    "how.intention.body": "Before the noise of the world rushes in, take 20 seconds to set a clear intention for your attention today (\"Dinner without my phone\", \"Deep focus\"). Behavioral science shows that pre-commitment dramatically cuts impulsive phone pickups before they begin.",
    "how.pause.title": "The 60-Second Somatic Pause",
    "how.pause.body": "When your thumb reaches for Instagram or TikTok on autopilot, you don't hit a punitive lock. A warm amber screen, an organic breathing orb, and gentle haptic pulses meet you instead. Sixty seconds stimulate the vagus nerve, soothe the dopamine urge, and return control to your prefrontal cortex. You decide if you still enter.",
    "how.home.title": "The Evening Close & Journal",
    "how.home.quote": "The day closes quietly.",
    "how.home.body": "Instead of revenge bedtime scrolling in the dark, close the loop. Look over the moments you reclaimed today, empty your thoughts into your private journal, and let the day rest without blue light.",
  ...
  es: {
    ...
    "how.subtitle": "El bucle de autorregulación diaria. Del reflejo a la decisión en tres momentos.",
    "how.intention.title": "La Intención Matutina",
    "how.intention.body": "Antes de que el ruido del mundo te arrastre, abres la app y declaras en 20 segundos cómo deseas cuidar tu atención hoy («Cena sin teléfono», «Foco en mi trabajo»). La psicología del comportamiento demuestra que anticipar tu decisión reduce drásticamente el hábito de mirar el móvil sin pensar.",
    "how.pause.title": "La Pausa Somática de 60s",
    "how.pause.body": "Cuando tu pulgar busca Instagram, TikTok o X por puro reflejo, no te encuentras con un candado que te frustre. Te recibe una pantalla ámbar con un orbe fluido y pulsos hápticos suaves que guían tu respiración diafragmática. 60 segundos bastan para calmar el impulso de dopamina y devolver el control a tu corteza prefrontal. Eres libre de entrar si lo decides.",
    "how.home.title": "El Cierre y Diario Nocturno",
    "how.home.quote": "El día se apaga en calma.",
    "how.home.body": "Por la noche, en lugar de caer en el scrolling de venganza en la cama, cierras el bucle. Revisas los momentos que recuperaste para ti hoy, descargas tus pensamientos en tu diario íntimo y dejas que la mente descanse sin pantallas iluminando tu rostro.",
  ...
  it: {
    ...
    "how.subtitle": "Il ciclo di autoregolazione quotidiana. Dal riflesso alla scelta in tre momenti.",
    "how.intention.title": "L'Intenzione Mattutina",
    "how.intention.body": "Prima che il rumore del mondo ti travolga, prenditi 20 secondi per dichiarare una gentile intenzione per la tua attenzione oggi. La scienza del comportamento dimostra che pre-impegnarsi riduce drasticamente l'abitudine di controllare il telefono senza pensare.",
    "how.pause.title": "La Pausa Somatica di 60s",
    "how.pause.body": "Quando il pollice apre un'app per puro riflesso, non trovi un blocco punitivo. Ti accoglie uno schermo ambrato con un orbe fluido e delicate vibrazioni aptiche. Sessanta secondi per stimolare il nervo vago e calmare il picco di dopamina. Se decidi di entrare, lo fai con consapevolezza.",
    "how.home.title": "La Chiusura e Diario Serale",
    "how.home.quote": "La giornata si chiude in quiete.",
    "how.home.body": "La sera, invece di scorrere all'infinito a letto, chiudi il cerchio. Rivedi i momenti che hai recuperato per te oggi, svuota la mente nel tuo diario privato e lascia che la giornata si concluda in pace.",
