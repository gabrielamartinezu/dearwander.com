...
faq:
  - q: "Why do people with ADHD doomscroll more than others?"
    a: "ADHD brains have lower baseline dopamine levels, which makes them more responsive to dopamine-seeking behaviors like scrolling. Combined with hyperfocus tendencies, impulse control differences, and time blindness, social media becomes a neurological buffet that's extremely hard to step away from. It's brain architecture meeting intentional app design."
  - q: "Do screen time blockers work for ADHD?"
    a: "Traditional hard-blocking apps often backfire for ADHD brains. They can feel punitive and trigger rejection sensitivity dysphoria (RSD), a common ADHD experience. Gentle friction approaches that offer choice rather than punishment tend to work better because they respect the ADHD need for autonomy."
  - q: "How much does phone use affect ADHD symptoms?"
...
This is what a [breathing pause](/blog/science-of-the-60-second-pause/) does. When you reach for your phone or when a scroll session extends past a threshold, a 60-second breathing exercise appears. It's not blocking you. It's not telling you that you're wrong for wanting to scroll. It's just creating a gap between the impulse and the action.
...
[Dear Wander](/) was built around the principle that your phone relationship shouldn't be adversarial. That screen time support should feel like a [friend, not a warden](/blog/why-screen-time-apps-shouldnt-punish-you/). For ADHD brains, this distinction isn't a nice-to-have. It's the difference between something you'll actually use and something you'll uninstall within a week.

## Building a different pattern

[Doomscrolling](/blog/how-to-stop-doomscrolling/) isn't a fixed identity. It's a pattern. Patterns can shift. For ADHD brains, that shift requires tools designed with your neurology in mind, not against it.
