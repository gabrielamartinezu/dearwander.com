---
title: "Las ganas de un dumbphone: por qué quieres tirar tu smartphone (y qué probar antes)"
description: "El 45% de los usuarios de smartphone han considerado cambiarse a un dumbphone. Antes de comprar uno, hay un punto medio que mantiene tus apps y calma tu cerebro."
date: 2026-05-16
author: "Dear Wander"
tags: ["dumbphone", "bienestar digital", "adicción al teléfono", "estrategias", "minimalismo digital"]
faq:
  - q: "¿Debería cambiarme a un dumbphone?"
    a: "Depende de tu vida. Si no necesitas mapas, apps de banco, servicios de transporte o chats grupales, un dumbphone puede funcionar. Pero la mayoría necesita la funcionalidad del smartphone para el día a día. Un enfoque basado en fricción en tu teléfono actual te da los beneficios de menos scroll sin perder herramientas esenciales."
  - q: "¿Qué es la energía dumbphone?"
    a: "Energía dumbphone significa usar tu smartphone con la intencionalidad de alguien que solo tiene un teléfono básico. Conservas las herramientas que necesitas (mapas, banco, mensajes) pero agregas fricción antes de las apps que te quitan tiempo. El objetivo es que tu teléfono se sienta aburrido por defecto y útil a propósito."
  - q: "¿Cuáles son las mejores alternativas al dumbphone para iPhone?"
    a: "Las apps que agregan fricción antes de las redes sociales pueden replicar la experiencia dumbphone en tu iPhone. One Sec usa un ejercicio de respiración, ScreenZen agrega retrasos, y Dear Wander coloca una pausa guiada de 60 segundos antes de tus apps elegidas. Así mantienes la utilidad de tu smartphone mientras reduces el scroll sin sentido."
  - q: "¿Por qué la gente vuelve al smartphone después del dumbphone?"
    a: "Las razones más comunes son perder acceso a mapas y GPS, apps de banco, transporte (Uber/Lyft), chats grupales con fotos y apps de trabajo. Muchos terminan cargando dos teléfonos, lo que anula la simplicidad que buscaban."
---
...
Ve a Configuración, recorre tu lista de notificaciones, y desactiva todo excepto llamadas y mensajes de humanos reales. Sin insignias de apps. Sin alertas de noticias, compras o redes sociales. Cada notificación es [una palomita reventando en tu cerebro](/blog/popcorn-brain/). Menos palomitas, más calma.
