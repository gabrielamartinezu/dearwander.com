...
faq:
  - q: "¿Por qué las personas con ADHD hacen más doomscrolling que otras?"
    a: "Los cerebros con ADHD tienen niveles basales de dopamina más bajos, lo que los hace más receptivos a comportamientos de búsqueda de dopamina como el scrolling. Combinado con tendencias al hiperfoco, diferencias en el control de impulsos y ceguera temporal, las redes sociales se convierten en un buffet neurológico del que es extremadamente difícil alejarse. Es la arquitectura cerebral encontrándose con el diseño intencional de las apps."
  - q: "¿Funcionan los bloqueadores de tiempo de pantalla para el ADHD?"
    a: "Las apps de bloqueo duro suelen ser contraproducentes para cerebros con ADHD. Pueden sentirse punitivas y activar la disforia de sensibilidad al rechazo (RSD), una experiencia común en el ADHD. Los enfoques de fricción suave que ofrecen elección en lugar de castigo tienden a funcionar mejor porque respetan la necesidad de autonomía del ADHD."
  - q: "¿Cuánto afecta el uso del teléfono a los síntomas de ADHD?"
...
Esto es lo que hace una [pausa de respiración](/blog/science-of-the-60-second-pause/). Cuando buscas tu teléfono o cuando una sesión de scroll supera un umbral, aparece un ejercicio de respiración de 60 segundos. No te está bloqueando. No te está diciendo que estás mal por querer hacer scroll. Solo está creando un espacio entre el impulso y la acción.
...
El [doomscrolling](/blog/how-to-stop-doomscrolling/) no es una identidad fija. Es un patrón. Los patrones pueden cambiar. Para cerebros con ADHD, ese cambio requiere herramientas diseñadas con tu neurología en mente, no en su contra.
