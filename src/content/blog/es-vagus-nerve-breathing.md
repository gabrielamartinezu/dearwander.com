---
title: "Respiración del nervio vago: por qué una exhalación lenta te calma"
description: "La respiración del nervio vago funciona por un truco fisiológico: la exhalación larga. Así sube el tono vagal y se calma la ansiedad."
date: 2026-06-15
author: "Dear Wander"
tags: ["science", "breathing", "mindfulness", "the pause"]
faq:
  - q: "¿Qué es la respiración del nervio vago?"
    a: "Es una respiración lenta centrada en la exhalación que estimula el nervio vago, el nervio principal del sistema de descanso y digestión. Las exhalaciones más largas te llevan hacia un estado parasimpático más calmado."
  - q: "¿Cómo calma la ansiedad la respiración?"
    a: "En cada exhalación, el nervio vago libera acetilcolina, que frena el ritmo cardíaco. Exhalaciones más lentas y largas significan más tiempo en ese estado de calma, lo que reduce las sensaciones físicas que alimentan la ansiedad."
  - q: "¿Cuál es el mejor ritmo de respiración para el tono vagal?"
    a: "La mayoría de los estudios apuntan a unas 6 respiraciones por minuto, más o menos 5 segundos de inhalación y 5 de exhalación. Ese ritmo suele maximizar la variabilidad de la frecuencia cardíaca, una medida común del tono vagal."
  - q: "¿De verdad sirve una sola sesión de respiración lenta?"
    a: "Sí. Un estudio de 2021 en Scientific Reports descubrió que una sola sesión de respiración profunda y lenta mejoró el tono vagal y redujo la ansiedad tanto en personas jóvenes como mayores."
---
...
Si tu mente se dispersa, no pasa nada. El nervio vago responde a la respiración, no a tu concentración. Esto combina bien con [una práctica breve de imaginación guiada](/blog/guided-imagery-meditation/) si quieres algo donde apoyar la atención.
...
Ese hueco entre alcanzar el teléfono y tocar la pantalla suele ser puro piloto automático, un estado reactivo y algo acelerado. Unas respiraciones lentas ahí son un cambio fisiológico real, no una idea bonita. Trabajas el mismo freno de acetilcolina, solo que de pie en una cocina en vez de en un estudio de yoga. La ciencia detrás de por qué [una pausa de 60 segundos cambia tus decisiones](/blog/science-of-the-60-second-pause/) es en parte este mismo mecanismo.

También resignifica esos pequeños momentos de alivio a lo largo del día. La respiración honda antes de una reunión, el suspiro en un semáforo en verde. Son [glimmers](/blog/glimmers/), diminutas señales de seguridad que tu cuerpo emite, y tu nervio vago es el cableado que las sostiene.

Y explica por qué buscar calma a través del teléfono sale al revés. Un pico de dopamina del feed no hace nada por el tono vagal. Si acaso te empuja hacia el otro lado, que es parte de por qué la [idea del ayuno de dopamina no da en el clavo](/blog/dopamine-detox/). Tu cuerpo no pedía novedad. Pedía una exhalación más lenta.
